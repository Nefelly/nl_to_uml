...
REDIS_KEY_FORBIDDEN_SESSION_USER = 'forbidden_session_userid:{session}'
...
REDIS_HUANXIN_SIG_ACCESS_TOKEN = 'huanxin_access_token'
REDIS_HUANXIN_SIG_ACCESS_TOKEN_EXPIRE = 'huanxin_access_token_expire'

...
class DiamStatService(object):
    ...
    """
    STAT_QUERY_LIST = {
        'consumer_num': 'name:deposit or name:success_vip| SELECT COUNT(DISTINCT user_id) as res',
        'vip_income_diamonds': 'name:success_vip | SELECT COUNT(1) as res',
        ...
        'diam_accost_cons_num': 'name:"accost_reset" or name : "reset accost" or name:"unlock_accost" or name:"accost_reset" | SELECT -sum(diamonds) as res',
        ...
        'reset_comment_people_num':'name:"reset comment" or name:"unlock_comment" | SELECT COUNT(DISTINCT user_id) as res',
        'reset_comment_man_time':'name:"reset comment" or name:"unlock_comment" | SELECT COUNT(1) as res',
        'reset_comment_diam_cons_num':'name:"reset comment" or name:"unlock_comment" | SELECT -sum(diamonds) as res',
